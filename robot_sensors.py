...
class RobotSensors:
    def __init__(self):
        ...
        # Kalman filter:
        self.wall_sensor_probs = {"mean":0, "sigma": 0}
...
# YOUR CODE HERE
        self.sensor_prob_dict = {"door": {}, "no_door": {}}
...
# YOUR CODE HERE
        door = {"see": in_prob_see_door_if_door, "nosee": 1 - in_prob_see_door_if_door}
        no_door = {"see":in_prob_see_door_if_not_door, "nosee": 1 - in_prob_see_door_if_not_door}
        self.sensor_prob_dict["door"] = door
        self.sensor_prob_dict["no_door"] = no_door
    ...
    def set_distance_wall_sensor_probabilities(self, sigma=0.1):
        ...
        # YOUR CODE HERE
        self.wall_sensor_probs["sigma"] = sigma
...
# YOUR CODE HERE
        door = self.sensor_prob_dict["door"]
        nodoor = self.sensor_prob_dict["no_door"]
        if is_in_front_of_door:
            zero_to_one = np.random.uniform(0,1)
            if zero_to_one < door["see"]: return True
            else: return False
        else:
            zero_to_one = np.random.uniform(0,1)
            if zero_to_one < nodoor["see"]: return True
            else: return False
...
# YOUR CODE HERE
        sigma = self.wall_sensor_probs["sigma"]
        loca = robot_gt.robot_loc
        loca += np.random.normal(0, sigma)
